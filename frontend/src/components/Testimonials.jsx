...
function Testimonials() {
    return (
        <section id="testimonials" className="container mx-auto px-4 py-20 text-white">
            <h2 className="text-5xl font-montserrat font-bold text-center mb-12">Endorsements</h2>
